defmodule ProgrammingPhoenixLiveviewWeb.Presence do
  # this file defines our presence model
  # which is the data structure that tracks info about active users on a site
  # and the functions that process changes in that model
