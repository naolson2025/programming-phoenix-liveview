defmodule ProgrammingPhoenixLiveviewWeb.GameLive.Component do
  use Phoenix.Component
  alias ProgrammingPhoenixLiveview.Game.Pentomino
  import ProgrammingPhoenixLiveviewWeb.GameLive.Colors
  @width 10
