defmodule ProgrammingPhoenixLiveviewWeb.GameLive.Board do
  use ProgrammingPhoenixLiveviewWeb, :live_component
  alias ProgrammingPhoenixLiveview.Game.Board
  alias ProgrammingPhoenixLiveview.Game
  import ProgrammingPhoenixLiveviewWeb.GameLive.{Colors, Component}
