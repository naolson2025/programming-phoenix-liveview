defmodule ProgrammingPhoenixLiveviewWeb.GameLive do
  use ProgrammingPhoenixLiveviewWeb, :live_view
  import ProgrammingPhoenixLiveviewWeb.GameLive.Component
  alias ProgrammingPhoenixLiveviewWeb.GameLive.Board
  ...
  def help_button(assigns) do
    ...
    <button phx-click={JS.toggle(to: "#info")}>
      <Heroicons.question_mark_circle mini class={@class} />
    </button>
    """
  end
